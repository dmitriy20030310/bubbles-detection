# Проект детекции пузырей на бифильных поверхностях при кипении жидкости

## Описание проекта

Данный проект представляет собой систему для детекции пузырьков при кипении жидкости с использованием нейронных сетей. 

### Задача

Задача заключается в детекции пузырьков при кипении жидкости и определении их местоположения с помощью bounding boxes. Модель должна предсказывать координаты прямоугольники, ограничивающие пузыри на изображении.
...
```bash
git clone https://github.com/dmitriy20030310/bubbles-detection
...
dvc get https://huggingface.co/Dmitriykil/bubbles-detection model.pt -o core/weights
```
